...
repackwrt() {
    ...
    # Define constants
    local readonly OPHUB_REPO="https://github.com/ElysianWhirl/amlogic-s9xxx-openwrt/archive/refs/heads/main.zip"
    local readonly ULO_REPO="https://github.com/ElysianWhirl/ULO-Builder/archive/refs/heads/main.zip"
